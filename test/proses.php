<?php
	...
	while ($data = mysql_fetch_array($select)) {
		...
		echo "<br>";
		$word_count = array_count_values($kata);
		arsort($word_count);
		...
		echo "---------------------------------------------";
		echo "<br>";
		echo "<b><h3>Hasil " .$jumlah. " Frekuensi Teratas</h3></b>";
		echo "<table border='1'>";
		echo "<tr><th>Kata</th><th>Frekuensi</th></tr>";
		$word_count2 = (array_slice($word_count, 0, $jumlah));
...
?>
		...
		class Keywords
		{
		   ...
		   public function getKeywords($text, $nbrwords2 = 5)
		   {
		      $words2 = str_word_count($text, 1);
		...
		$test = new Keywords();
		$keywords2 = $test->getKeywords($text, $jumlah3);
		echo "<br>";
		echo "<b><h3>Hasil " .$jumlah. " Frekuensi Teratas</h3></b>";
		echo "<table border='1'>";
		echo "<tr><th>Kata</th></tr>";
		$wordCount2 = (array_slice($keywords2, 0, $jumlah));
