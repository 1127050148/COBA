...
function preproses($teks) {
    ...
    $astoplist = array ("yang", "juga", "dari", "dia", "kami", "kamu", "ini", "itu", 
                               "atau", "dan", "tersebut", "pada", "dengan", "adalah", "yaitu","D");     
...
//contoh penggunaan
$berita = "Yang spesial dari rencana kepindahan Jose Mourinho ke Real Madrid adalah :D pertemuan dia dengan Cristiano Ronaldo. Mengaku tak sabar bertemu rekan senegaranya itu, Mourinho juga berharap banyak gol dari CR9."; 
